...
public class SaveForLaterTest  extends BaseClass {

	@Test
	public void saveForLaterTest() throws IOException
	{
        ...
        SearchProductResultPage srp=new SearchProductResultPage(driver);
     		  ...
     		  cp.clickOnSaveForLaterBtn();
     		  System.out.println("The product saved in saved items folder");
	}
}
